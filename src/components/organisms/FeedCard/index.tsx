...
const example: RecordPost = {
  ...
  content:
    '안녕하세요 저는 레니니 본인이고 저는 지금 실수를 했습니다. 아주 큰 실수입니다. 눈 감아주세요. 감사합니다. 이건 네줄을 넘기 위한 노력입니다. 하하하 이제 넘네요~~ ㅎㅎ 아직 아니네요 조금만 더 작성하면 될 것 같습니다.안녕하세요 저는 레니니 본인이고 저는 지금 실수를 했습니다. 아주 큰 실수입니다. 눈 감아주세요. 감사합니다. 이건 네줄을 넘기 위한 노력입니다. 하하하 이제 넘네요~~ ㅎㅎ 아직 아니네요 조금만 더 작성하면 될 것 같습니다.안녕하세요 저는 레니니 본인이고 저는 지금 실수를 했습니다. 아주 큰 실수입니다. 눈 감아주세요. 감사합니다. 이건 네줄을 넘기 위한 노력입니다. 하하하 이제 넘네요~~ ㅎㅎ 아직 아니네요 조금만 더 작성하면 될 것 같습니다.안녕하세요 저는 레니니 본인이고 저는 지금 실수를 했습니다. 아주 큰 실수입니다. 눈 감아주세요. 감사합니다. 이건 네줄을 넘기 위한 노력입니다. 하하하 이제 넘네요~~ ㅎㅎ 아ㅔᆼᆫᆫㅏㅈ긴ㅇ바인ㅈ가ㅣ자ㅇ진ㅏ긴자기',
  impression:
